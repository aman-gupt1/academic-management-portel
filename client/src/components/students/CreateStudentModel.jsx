        ...
        <div className="w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl">
          ...
          <div className="border-t bg-slate-50 p-3 md:p-4">
            <div className="flex gap-2">
              <button
                onClick={onClose}
                className="w-1/2 rounded-xl border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="w-1/2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700"
              >
                Create Student
              </button>
            </div>
